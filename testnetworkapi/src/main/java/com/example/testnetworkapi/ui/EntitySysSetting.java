 ...
 */
public class EntitySysSetting
{

    /**
     * rcode : 200
     * msg : OK
     * data : {"bAutoCPHDZ":"1","bCentralCharge":"0","bOutCharge":"0","bMorePaingCar":"0","bMorePaingType":"0","bOnlinePayEnabled":"0","strWXAppID":"wxb65107b2b88e658f","strWXMCHID":"123456","strWXKEY":"08283c3aa6720effdddd07b7d9884a0d","strZFBAppID":"wxb65107b2b88e658f","strZFBPID":"08283c3aa6720effdddd07b7d9884a0d","iChargeType":"0","iXsdNum":"1","iXsd":"0","iZGXE":"0","iZGType":"0","iZGXEType":"1","iDiscount":"0","iYKOverTimeCharge":"1","iMothOverDay":"1","bForbidSamePosition":"1","bMonthRule":"1","iEnableNetVideo":"1","bVideo4":"0","iPersonVideo":"0","iIDCapture":"0","sImageSavePath":"D:main","bImageAutoDel":"0","iImageSaveDays":"120","iImageAutoDelTime":"1","iFreeCar":"0","bSetTempMoney":"0","bModiTempType_VoiceSF":"0","bSFCancel":"0","bSetTempCardType":"0","iLoadTimeInterval":"20","bDisplayTime":"0","iShowGateState":"1","iExitOnlineByPwd":"0","bSoftOpenNoPlate":"0","bCheDui":"0","bExceptionHandle":"0","bShowBoxCardNum":"0","bAutoPrePlate":"0","bCheckPortFirst":"0","iFullLight":"0","iVideoShiftTime":"5","bIDSoftOpen":"1","iInOutLimitSeconds":"0","iRealTimeDownLoad":"0","bIdSfCancel":"0","iICCardDownLoad":"0","bIdReReadHandle":"0","bIdPlateDownLoad":"1","iIDOneInOneOut":"0","iIDComfirmOpen":"0","bCtrlShowPlate":"1","bCtrlShowStayTime":"1","bCtrlShowCW":"0","bCtrlShowInfo":"0","bCtrlShowRemainPos":"0","iCtrlVoiceLedVersion":"1","iCtrlVoiceMode":"0","iIDNoticeDay":"10","iBillPrint":"0","bBillPrintAuto":"0","iPrintFontSize":"8","iCarPosCom":"0","iCarPosLedLen":"0","iSFLedCom":"0","iSFLedType":"0","bRemainPosLedShowInfo":"0","bRemainPosLedShowPlate":"0","bReLoginPrint":"0","bBarCodePrint":"0","bCtrlSetHasPwd":"1","bQueryName":"0","iWorkstationNo":"1","iParkingNo":"1","strAreaDefault":"京","bFreeCardNoInPlace":"0","bDetailLog":"0","bSumMoneyHide":"0","iParkTotalSpaces":"999","iTempCarPlaceNum":"0","iMonthCarPlaceNum":"0","iMoneyCarPlaceNum":"0","iOnlyShowThisRemainPos":"0","bOneKeyShortCut":"0","bTempDown":"1","bAutoMinutes":"0","LocalProvince":"粤","bAutoUpdateJiHao":"0","iSFLed":"1","iAutoSetMinutes":"5","bAutoPlateEn":"1","iAutoPlateDBJD":"2","iInAutoOpenModel":"0","iOutAutoOpenModel":"1","iInMothOpenModel":"0","iOutMothOpenModel":"0","bCPHPhoto":"1","iAutoDeleteImg":"0","iSameCphDelay":"0","iCarPosLed":"1","iAutoKZ":"1","iAutoColorSet":"0","iAuto0Set":"0","bNoCPHAutoKZ":"0","bTempCanNotInSmall":"0","bOutSF":"0","iCarPosLedJH":"0","iCphDelay":"","iTempFree":"0","sID1In1OutCardType":"","iDelayed":"15","iPromptDelayed":"5","OCar":"1","bSpecilCPH":"0","bCphAllEn":"0","bCphAllSame":"0","bCarYellowTmp":"0","strCarYellowTmpType":"TmpA","sMonthOutChargeType":"","bOnlyLocation":"0","bFullComfirmOpen":"0","bAppEnable":"0"}
     */
     ...
     * bMorePaingType : 0
     * bOnlinePayEnabled : 0
     * strWXAppID : wxb65107b2b88e658f
     * strWXMCHID : 123456
     * strWXKEY : 08283c3aa6720effdddd07b7d9884a0d
     * strZFBAppID : wxb65107b2b88e658f
     * strZFBPID : 08283c3aa6720effdddd07b7d9884a0d
     * iChargeType : 0
     * iXsdNum : 1
     * iXsd : 0
     * iZGXE : 0
     ...
     * iYKOverTimeCharge : 1
     * iMothOverDay : 1
     * bForbidSamePosition : 1
     * bMonthRule : 1
     * iEnableNetVideo : 1
     * bVideo4 : 0
     * iPersonVideo : 0
     * iIDCapture : 0
     * sImageSavePath : D:main
     * bImageAutoDel : 0
     * iImageSaveDays : 120
     * iImageAutoDelTime : 1
     * iFreeCar : 0
     * bSetTempMoney : 0
     * bModiTempType_VoiceSF : 0
     * bSFCancel : 0
     * bSetTempCardType : 0
     * iLoadTimeInterval : 20
     * bDisplayTime : 0
     * iShowGateState : 1
     * iExitOnlineByPwd : 0
     * bSoftOpenNoPlate : 0
     ...
     * bCtrlShowCW : 0
     * bCtrlShowInfo : 0
     * bCtrlShowRemainPos : 0
     * iCtrlVoiceLedVersion : 1
     * iCtrlVoiceMode : 0
     * iIDNoticeDay : 10
     * iBillPrint : 0
     * bBillPrintAuto : 0
     ...
     * iSFLedCom : 0
     * iSFLedType : 0
     * bRemainPosLedShowInfo : 0
     * bRemainPosLedShowPlate : 0
     * bReLoginPrint : 0
     * bBarCodePrint : 0
     * bCtrlSetHasPwd : 1
     * bQueryName : 0
     ...
     * iParkingNo : 1
     * strAreaDefault : 京
     * bFreeCardNoInPlace : 0
     * bDetailLog : 0
     * bSumMoneyHide : 0
     * iParkTotalSpaces : 999
     * iTempCarPlaceNum : 0
     * iMonthCarPlaceNum : 0
     * iMoneyCarPlaceNum : 0
     * iOnlyShowThisRemainPos : 0
     * bOneKeyShortCut : 0
     * bTempDown : 1
     * bAutoMinutes : 0
     * LocalProvince : 粤
    ...
    {
        return "EntitySysSetting{" +
                "bAutoCPHDZ='" + bAutoCPHDZ + '\'' +
                ", bCentralCharge='" + bCentralCharge + '\'' +
                ", bOutCharge='" + bOutCharge + '\'' +
                ", bMorePaingCar='" + bMorePaingCar + '\'' +
                ", bMorePaingType='" + bMorePaingType + '\'' +
                ", bOnlinePayEnabled='" + bOnlinePayEnabled + '\'' +
                ", strWXAppID='" + strWXAppID + '\'' +
                ", strWXMCHID='" + strWXMCHID + '\'' +
                ", strWXKEY='" + strWXKEY + '\'' +
                ", strZFBAppID='" + strZFBAppID + '\'' +
                ", strZFBPID='" + strZFBPID + '\'' +
                ...
                ", iZGXEType='" + iZGXEType + '\'' +
                ", iDiscount='" + iDiscount + '\'' +
                ", iYKOverTimeCharge='" + iYKOverTimeCharge + '\'' +
                ", iMothOverDay='" + iMothOverDay + '\'' +
                ", bForbidSamePosition='" + bForbidSamePosition + '\'' +
                ", bMonthRule='" + bMonthRule + '\'' +
                ", iEnableNetVideo='" + iEnableNetVideo + '\'' +
                ", bVideo4='" + bVideo4 + '\'' +
                ", iPersonVideo='" + iPersonVideo + '\'' +
                ", iIDCapture='" + iIDCapture + '\'' +
                ", sImageSavePath='" + sImageSavePath + '\'' +
                ", bImageAutoDel='" + bImageAutoDel + '\'' +
                ", iImageSaveDays='" + iImageSaveDays + '\'' +
                ", iImageAutoDelTime='" + iImageAutoDelTime + '\'' +
                ", iFreeCar='" + iFreeCar + '\'' +
                ", bSetTempMoney='" + bSetTempMoney + '\'' +
                ", bModiTempType_VoiceSF='" + bModiTempType_VoiceSF + '\'' +
                ", bSFCancel='" + bSFCancel + '\'' +
                ", bSetTempCardType='" + bSetTempCardType + '\'' +
                ", iLoadTimeInterval='" + iLoadTimeInterval + '\'' +
                ", bDisplayTime='" + bDisplayTime + '\'' +
                ", iShowGateState='" + iShowGateState + '\'' +
                ", iExitOnlineByPwd='" + iExitOnlineByPwd + '\'' +
                ", bSoftOpenNoPlate='" + bSoftOpenNoPlate + '\'' +
                ", bCheDui='" + bCheDui + '\'' +
                ", bExceptionHandle='" + bExceptionHandle + '\'' +
                ", bShowBoxCardNum='" + bShowBoxCardNum + '\'' +
                ", bAutoPrePlate='" + bAutoPrePlate + '\'' +
                ", bCheckPortFirst='" + bCheckPortFirst + '\'' +
                ", iFullLight='" + iFullLight + '\'' +
                ", iVideoShiftTime='" + iVideoShiftTime + '\'' +
                ", bIDSoftOpen='" + bIDSoftOpen + '\'' +
                ", iInOutLimitSeconds='" + iInOutLimitSeconds + '\'' +
                ", iRealTimeDownLoad='" + iRealTimeDownLoad + '\'' +
                ", bIdSfCancel='" + bIdSfCancel + '\'' +
                ", iICCardDownLoad='" + iICCardDownLoad + '\'' +
                ", bIdReReadHandle='" + bIdReReadHandle + '\'' +
                ", bIdPlateDownLoad='" + bIdPlateDownLoad + '\'' +
                ", iIDOneInOneOut='" + iIDOneInOneOut + '\'' +
                ", iIDComfirmOpen='" + iIDComfirmOpen + '\'' +
                ", bCtrlShowPlate='" + bCtrlShowPlate + '\'' +
                ", bCtrlShowStayTime='" + bCtrlShowStayTime + '\'' +
                ", bCtrlShowCW='" + bCtrlShowCW + '\'' +
                ", bCtrlShowInfo='" + bCtrlShowInfo + '\'' +
                ", bCtrlShowRemainPos='" + bCtrlShowRemainPos + '\'' +
                ", iCtrlVoiceLedVersion='" + iCtrlVoiceLedVersion + '\'' +
                ", iCtrlVoiceMode='" + iCtrlVoiceMode + '\'' +
                ", iIDNoticeDay='" + iIDNoticeDay + '\'' +
                ", iBillPrint='" + iBillPrint + '\'' +
                ", bBillPrintAuto='" + bBillPrintAuto + '\'' +
                ", iPrintFontSize='" + iPrintFontSize + '\'' +
                ", iCarPosCom='" + iCarPosCom + '\'' +
                ", iCarPosLedLen='" + iCarPosLedLen + '\'' +
                ", iSFLedCom='" + iSFLedCom + '\'' +
                ", iSFLedType='" + iSFLedType + '\'' +
                ", bRemainPosLedShowInfo='" + bRemainPosLedShowInfo + '\'' +
                ", bRemainPosLedShowPlate='" + bRemainPosLedShowPlate + '\'' +
                ", bReLoginPrint='" + bReLoginPrint + '\'' +
                ", bBarCodePrint='" + bBarCodePrint + '\'' +
                ", bCtrlSetHasPwd='" + bCtrlSetHasPwd + '\'' +
                ", bQueryName='" + bQueryName + '\'' +
                ", iWorkstationNo='" + iWorkstationNo + '\'' +
                ", iParkingNo='" + iParkingNo + '\'' +
                ", strAreaDefault='" + strAreaDefault + '\'' +
                ", bFreeCardNoInPlace='" + bFreeCardNoInPlace + '\'' +
                ", bDetailLog='" + bDetailLog + '\'' +
                ", bSumMoneyHide='" + bSumMoneyHide + '\'' +
                ", iParkTotalSpaces='" + iParkTotalSpaces + '\'' +
                ", iTempCarPlaceNum='" + iTempCarPlaceNum + '\'' +
                ", iMonthCarPlaceNum='" + iMonthCarPlaceNum + '\'' +
                ", iMoneyCarPlaceNum='" + iMoneyCarPlaceNum + '\'' +
                ", iOnlyShowThisRemainPos='" + iOnlyShowThisRemainPos + '\'' +
                ", bOneKeyShortCut='" + bOneKeyShortCut + '\'' +
                ", bTempDown='" + bTempDown + '\'' +
                ", bAutoMinutes='" + bAutoMinutes + '\'' +
                ", LocalProvince='" + LocalProvince + '\'' +
                ", bAutoUpdateJiHao='" + bAutoUpdateJiHao + '\'' +
                ", iSFLed='" + iSFLed + '\'' +
                ", iAutoSetMinutes='" + iAutoSetMinutes + '\'' +
                ", bAutoPlateEn='" + bAutoPlateEn + '\'' +
                ", iAutoPlateDBJD='" + iAutoPlateDBJD + '\'' +
                ", iInAutoOpenModel='" + iInAutoOpenModel + '\'' +
                ", iOutAutoOpenModel='" + iOutAutoOpenModel + '\'' +
                ", iInMothOpenModel='" + iInMothOpenModel + '\'' +
                ", iOutMothOpenModel='" + iOutMothOpenModel + '\'' +
                ", bCPHPhoto='" + bCPHPhoto + '\'' +
                ", iAutoDeleteImg='" + iAutoDeleteImg + '\'' +
                ", iSameCphDelay='" + iSameCphDelay + '\'' +
                ", iCarPosLed='" + iCarPosLed + '\'' +
                ", iAutoKZ='" + iAutoKZ + '\'' +
                ", iAutoColorSet='" + iAutoColorSet + '\'' +
                ", iAuto0Set='" + iAuto0Set + '\'' +
                ", bNoCPHAutoKZ='" + bNoCPHAutoKZ + '\'' +
                ", bTempCanNotInSmall='" + bTempCanNotInSmall + '\'' +
                ", bOutSF='" + bOutSF + '\'' +
                ", iCarPosLedJH='" + iCarPosLedJH + '\'' +
                ", iCphDelay='" + iCphDelay + '\'' +
                ", iTempFree='" + iTempFree + '\'' +
                ", sID1In1OutCardType='" + sID1In1OutCardType + '\'' +
                ", iDelayed='" + iDelayed + '\'' +
                ", iPromptDelayed='" + iPromptDelayed + '\'' +
                ", OCar='" + OCar + '\'' +
                ", bSpecilCPH='" + bSpecilCPH + '\'' +
                ", bCphAllEn='" + bCphAllEn + '\'' +
                ", bCphAllSame='" + bCphAllSame + '\'' +
                ", bCarYellowTmp='" + bCarYellowTmp + '\'' +
                ", strCarYellowTmpType='" + strCarYellowTmpType + '\'' +
                ", sMonthOutChargeType='" + sMonthOutChargeType + '\'' +
                ", bOnlyLocation='" + bOnlyLocation + '\'' +
                ", bFullComfirmOpen='" + bFullComfirmOpen + '\'' +
                ", bAppEnable='" + bAppEnable + '\'' +
                '}';
    }
}
