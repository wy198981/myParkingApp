 ...
 */
public class ParkingInNoPlateView
{
    ...
    public ParkingInNoPlateView(Activity mActivity)
    {
        dialog = new Dialog(mActivity); // @android:style/Theme.Dialog
        dialog.setContentView(R.layout.pakingin_noplate);
    ...
    {
        btnNoPlateCancel = (Button) dialog.findViewById(R.id.btnNoPlateCancel);
        btnNoPlateCancel.setOnClickListener(dialogListener);
    }
